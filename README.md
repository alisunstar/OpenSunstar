...
[![Version](https://img.shields.io/badge/version-v1.1.7-blue.svg)](https://github.com/alisunstar/OpenSunstar/releases)
...
> **v1.1.7** — Orchestration plan → apply → verify → receipt with rollback; Flow Orchestrator UI dry-run and high-DPI window chrome fixes.
