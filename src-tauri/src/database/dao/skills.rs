...
//! - 实际文件存储在 ~/.OpenSunstar/skills/，同步到各应用目录
        ...
        let mut stmt = conn
            .prepare(
                "SELECT id, name, description, directory, repo_owner, repo_name, repo_branch,
                        ...
                        enabled_hermes, enabled_grokbuild, installed_at, content_hash, updated_at
        ...
        conn.execute(
            "INSERT OR REPLACE INTO skills
             (id, name, description, directory, repo_owner, repo_name, repo_branch,
              readme_url, enabled_claude, enabled_codex, enabled_gemini, enabled_opencode, enabled_hermes, enabled_grokbuild,
    ...
    pub fn update_skill_apps(&self, id: &str, apps: &SkillApps) -> Result<bool, AppError> {
        ...
        let affected = conn
            .execute(
                ...
                params![apps.claude, apps.codex, apps.gemini, apps.opencode, apps.hermes, apps.grokbuild, id],
            )
            .map_err(|e| AppError::Database(e.to_string()))?;
        Ok(affected > 0)
    }
