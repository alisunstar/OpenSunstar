...
//!
//! 本模块处理 OpenSunstar 统一 MCP 格式与 OpenCode 格式之间的转换。
//!
//! ## 格式差异
//!
//! | OpenSunstar 统一格式    | OpenCode 格式       |
//! |----------------------|---------------------|
...
/// Convert OpenSunstar unified format to OpenCode format
///
/// Conversion rules:
...
// ============================================================================
// Format Conversion: OpenCode → OpenSunstar
// ============================================================================

/// Convert OpenCode format to OpenSunstar unified format
///
/// Conversion rules:
