...
//!
//! Handles conversion between OpenSunstar unified MCP format and Hermes config.yaml format.
//!
//! ## Format mapping
//!
//! | OpenSunstar unified (JSON)                        | Hermes config.yaml (YAML)       |
//! |-------------------------------------------------|---------------------------------|
...
/// OpenSunstar has no OAuth UI, but losing the field on round-trip downgrades
...
/// Convert OpenSunstar unified format to Hermes format
///
/// Conversion rules:
...
// ============================================================================
// Format Conversion: Hermes -> OpenSunstar
// ============================================================================

/// Convert Hermes format to OpenSunstar unified format
///
/// Conversion rules:
...
/// `existing` — this prevents OpenSunstar from overwriting user customizations.
...
mod tests {
    ...
    fn test_merge_preserves_auth_field() {
        ...
        assert_eq!(
            merged["auth"], "oauth",
            "auth declaration must survive OpenSunstar round-trip"
        );
    }
