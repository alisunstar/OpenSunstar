...
//!
//! This module is used when the Codex client talks to OpenSunstar through the
...
pub(crate) fn response_id_from_chat_id(id: Option<&str>) -> String {
    let id = id.unwrap_or("OpenSunstar");
...
mod tests {
    ...
    // https://github.com/alisunstar/OpenSunstar/issues/3557
