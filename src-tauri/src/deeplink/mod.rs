//! Deep link import functionality for OpenSunstar
//!
//! This module implements the OpenSunstar:// protocol for importing configurations
...
///
/// Represents a parsed OpenSunstar:// URL ready for processing.
