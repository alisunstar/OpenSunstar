...
OpenSunstar provides a smart backfill protection mechanism to ensure your manual modifications are not lost.
...
```
OpenSunstar://import/prompt?data=<base64-encoded preset>
```
