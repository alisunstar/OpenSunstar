...
| File | Description |
|------|-------------|
| [5.1-config-files.md](./5-faq/5.1-config-files.md) | OpenSunstar storage, CLI configuration file formats |
...
- Applicable to OpenSunstar v3.16.0+
...
- [GitHub Issues](https://github.com/farion1231/OpenSunstar/issues)
- [GitHub Repository](https://github.com/farion1231/OpenSunstar)
