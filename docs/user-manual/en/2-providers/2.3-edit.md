...
OpenSunstar provides rich icon customization features:
...
This ensures OpenSunstar and CLI tool configurations stay in sync.
...
When adding a provider, OpenSunstar automatically extracts endpoint URLs from the configuration.
