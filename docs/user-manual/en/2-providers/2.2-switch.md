...
2. OpenSunstar updates the configuration file
...
1. Right-click the OpenSunstar icon in the system tray
...
When switching providers, OpenSunstar modifies the following files:
