...
sequenceDiagram
    ...
    participant Proxy as Local Proxy (OpenSunstar)
...
After starting the proxy and enabling app takeover, OpenSunstar modifies app configurations:
...
When stopping the proxy, OpenSunstar will:
