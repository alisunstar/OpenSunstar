...
OpenSunstar v3.8.0 is a major architectural upgrade that restructures the data persistence layer and user interface, laying the foundation for future cloud sync and local proxy features.
...
- **Windows**: `OpenSunstar-v3.8.0-Windows.msi` or `-Portable.zip`
- **macOS**: `OpenSunstar-v3.8.0-macOS.tar.gz` or `.zip`
- **Linux**: `OpenSunstar-v3.8.0-Linux.AppImage` or `.deb`
...
[Use code "OpenSunstar" for 10% off registration](https://www.packyapi.com/register?aff=OpenSunstar)
...
- **Issue Reports**: [GitHub Issues](https://github.com/farion1231/OpenSunstar/issues)
