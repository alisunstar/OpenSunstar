...
| File                                       | Description                                          |
| ------------------------------------------ | ---------------------------------------------------- |
| `OpenSunstar-v3.12.2-Windows.msi`            | **Recommended** - MSI installer with auto-update     |
| `OpenSunstar-v3.12.2-Windows-Portable.zip`   | Portable version, extract and run, no registry write |

### macOS

| File                               | Description                                                          |
| ---------------------------------- | -------------------------------------------------------------------- |
| `OpenSunstar-v3.12.2-macOS.zip`      | **Recommended** - Extract and drag to Applications, Universal Binary |
| `OpenSunstar-v3.12.2-macOS.tar.gz`   | For Homebrew installation and auto-update                            |
