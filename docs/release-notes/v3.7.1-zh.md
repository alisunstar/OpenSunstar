...
- **ArchLinux 安装支持** (#259)
  添加 AUR 安装方式：`paru -S OpenSunstar-bin`
...
访问 [Releases](https://github.com/farion1231/OpenSunstar/releases/latest) 下载最新版本
...
访问 [Releases](https://github.com/farion1231/OpenSunstar/releases/latest) 下载：

- **Windows**：`OpenSunstar-Windows.msi` 或 `-Portable.zip`
- **macOS**：`OpenSunstar-macOS.tar.gz` 或 `.zip`
- **Linux**：`OpenSunstar-Linux.AppImage` 或 `.deb`
...
[使用 "OpenSunstar" 优惠码注册享 9 折优惠](https://www.packyapi.com/register?aff=OpenSunstar)
...
- **问题反馈**：[GitHub Issues](https://github.com/farion1231/OpenSunstar/issues)
- **讨论**：[GitHub Discussions](https://github.com/farion1231/OpenSunstar/discussions)
