...
**[中文更新说明 Chinese Documentation →](https://github.com/farion1231/OpenSunstar/blob/main/docs/release-notes/v3.6.0-zh.md)**
...
- Download `OpenSunstar-v3.6.0-macOS.zip` from [Assets](#assets) below
...
- **Installer**: `OpenSunstar-v3.6.0-Windows.msi`
- **Portable**: `OpenSunstar-v3.6.0-Windows-Portable.zip`

### Linux

- **AppImage**: `OpenSunstar-v3.6.0-Linux.AppImage`
- **Debian**: `OpenSunstar-v3.6.0-Linux.deb`
...
**Full Changelog**: https://github.com/farion1231/OpenSunstar/compare/v3.5.1...v3.6.0
