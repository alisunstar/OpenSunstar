...
**[Use OpenSunstar to configure, manage, and switch Claude Desktop providers in one place](../user-manual/en/2-providers/2.6-claude-desktop.md)**
...
OpenSunstar now treats **Claude Desktop** as a first-class managed surface alongside Claude Code / Codex / Gemini / OpenCode / OpenClaw / Hermes.

- New dedicated Claude Desktop panel that brokers third-party providers to Claude Desktop through OpenSunstar's in-app proxy gateway
...
ChatGPT Codex providers no longer rely on a hardcoded model selection — OpenSunstar fetches a **live model list** from the ChatGPT backend on demand.
...
Switching a Claude Desktop provider writes OpenSunstar's managed 3P profile and **requires restarting Claude Desktop** to take effect; proxy-mode providers require OpenSunstar's Local Routing to stay running while in use.
...
### OpenSunstar Brand Surface Unified to OpenSunstar.io

All in-app and README "official website" references now point at OpenSunstar.io as the sole official site; the release notes template also surfaces OpenSunstar.io.
...
The release notes template now surfaces `OpenSunstar.io`.

### Brand Surface

Documented `OpenSunstar.io` as the sole official website across READMEs and in-app references.
...
| File                                     | Description                                           |
| ---------------------------------------- | ----------------------------------------------------- |
| `OpenSunstar-v3.15.0-Windows.msi`          | **Recommended** - MSI installer, supports auto-update |
| `OpenSunstar-v3.15.0-Windows-Portable.zip` | Portable, extract and run, no registry writes         |

### macOS

| File                             | Description                                             |
| -------------------------------- | ------------------------------------------------------- |
| `OpenSunstar-v3.15.0-macOS.dmg`    | **Recommended** - DMG installer, drag into Applications |
| `OpenSunstar-v3.15.0-macOS.zip`    | Extract and drag into Applications, Universal Binary    |
| `OpenSunstar-v3.15.0-macOS.tar.gz` | For Homebrew installation and auto-update               |
...
>
> - `OpenSunstar-v3.15.0-Linux-x86_64.AppImage` / `.deb` / `.rpm`
> - `OpenSunstar-v3.15.0-Linux-arm64.AppImage` / `.deb` / `.rpm`
