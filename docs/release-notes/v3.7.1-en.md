...
- **ArchLinux Installation Support** (#259)
  Added AUR installation method: `paru -S OpenSunstar-bin`
...
Visit [Releases](https://github.com/farion1231/OpenSunstar/releases/latest) to download the latest version
...
- **Deep link integration** - Import via `OpenSunstar://` protocol
...
v3.7.0 represents a shift in OpenSunstar's positioning:
...
Visit [Releases](https://github.com/farion1231/OpenSunstar/releases/latest) to download:

- **Windows**: `OpenSunstar-Windows.msi` or `-Portable.zip`
- **macOS**: `OpenSunstar-macOS.tar.gz` or `.zip`
- **Linux**: `OpenSunstar-Linux.AppImage` or `.deb`
- **ArchLinux**: `paru -S OpenSunstar-bin`
...
[Register with "OpenSunstar" code for 10% discount](https://www.packyapi.com/register?aff=OpenSunstar)
...
- **Issues**: [GitHub Issues](https://github.com/farion1231/OpenSunstar/issues)
- **Discussions**: [GitHub Discussions](https://github.com/farion1231/OpenSunstar/discussions)
