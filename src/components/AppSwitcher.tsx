...
const STORAGE_KEY = "OpenSunstar-last-app";
...
export function AppSwitcher({
  ...
  // Compact 模式下，claude 系列应用显示短标签以便区分
  const compactLabels: Partial<Record<AppId, string>> = {
    claude: "Code",
          ...
          >
            ...
            <span
              className={cn(
                ...
                compact
                  ? compactLabels[app]
                    ? "max-w-[60px] opacity-100 ml-1 text-[11px] font-normal text-muted-foreground"
