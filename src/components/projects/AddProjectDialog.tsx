          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              placeholder={t("projects.descPlaceholder", {
                defaultValue: "简要描述项目用途、技术栈或当前目标（可选）",
              })}
              rows={2}
              className="w-full rounded-lg border border-border bg-transparent px-3 py-2 text-sm placeholder:text-muted-foreground/60 focus:outline-none focus:ring-2 focus:ring-primary/20 resize-none"
            />
          </div>
        </div>
