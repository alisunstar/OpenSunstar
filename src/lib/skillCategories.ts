...
const SKILL_CATEGORY_RULES: [SkillCategory, RegExp][] = [
  [
    "writing",
    /写作|文章|改写|润色|文案|口播|翻译|\bwrit|article|blog|copywriting|translat|humaniz/i,
  ],
  ["slides", /ppt|slide|幻灯|演示|deck|presentation|keynote/i],
  [
    "media",
    /视频|音频|录音|字幕|播客|video|audio|ffmpeg|tts|asr|remotion|podcast|gif/i,
  ],
  [
    "coding",
    /代码|编程|coding|code\b|debug|lint|\bspec\b|mcp|skill.*creat|extension|plugin|git\b|refactor|review/i,
  ],
  [
    "data",
    /excel|表格|xlsx|csv|sql|database|analy|chart|plot|visualization|pandas|numpy/i,
  ],
  ["docs", /pdf|docx|word\b|document|markdown|report|简历|resume|readme/i],
  [
    "design",
    /图片|设计|海报|logo|绘图|image|design|draw|poster|figma|ui\s|ux\s|visual|canvas|art/i,
  ],
  [
    "product",
    /产品|prd|原型|需求|roadmap|竞品|okr|prototype|user[\s-]*stor|brainstorm|文档/i,
  ],
  [
    "collab",
    /飞书|lark|slack|notion|协作|collab|calendar|审批|知识库|wiki|team|团队/i,
  ],
  [
    "info",
    /rss|抓取|爬|采集|搜索|热点|scrap|search|news|trend|browser|fetch|web/i,
  ],
  [
    "devops",
    /部署|deploy|docker|k8s|kubernetes|monitor|日志|log\b|server|infra|ci\/cd|vercel|netlify/i,
  ],
  [
    "ai",
    /agent|llm|prompt|rag|embedding|fine.?tun|模型|model\b|ai\s|gpt|claude|gemini|codex/i,
  ],
];
...
export const SKILL_CATEGORIES: SkillCategoryInfo[] = [
  {
    ...
    pillActiveClass:
      "bg-green-500/20 text-green-800 dark:text-green-200 ring-1 ring-green-500/40",
  },
  {
    key: "writing",
    ...
    pillActiveClass:
      "bg-amber-500/20 text-amber-800 dark:text-amber-200 ring-1 ring-amber-500/40",
  },
  {
    key: "data",
  ...
  },
  {
    ...
    pillActiveClass:
      "bg-orange-500/20 text-orange-800 dark:text-orange-200 ring-1 ring-orange-500/40",
  },
  {
    key: "design",
    ...
    pillActiveClass:
      "bg-pink-500/20 text-pink-800 dark:text-pink-200 ring-1 ring-pink-500/40",
  },
  {
    key: "media",
    ...
    pillActiveClass:
      "bg-purple-500/20 text-purple-800 dark:text-purple-200 ring-1 ring-purple-500/40",
  },
  {
    key: "slides",
    ...
    pillActiveClass:
      "bg-red-500/20 text-red-800 dark:text-red-200 ring-1 ring-red-500/40",
  },
  {
    key: "product",
    ...
    pillActiveClass:
      "bg-teal-500/20 text-teal-800 dark:text-teal-200 ring-1 ring-teal-500/40",
  },
  {
    key: "collab",
    ...
    pillActiveClass:
      "bg-cyan-500/20 text-cyan-800 dark:text-cyan-200 ring-1 ring-cyan-500/40",
  },
  {
    key: "info",
    ...
    pillActiveClass:
      "bg-yellow-500/20 text-yellow-800 dark:text-yellow-200 ring-1 ring-yellow-500/40",
  },
  {
    key: "devops",
    ...
    pillActiveClass:
      "bg-slate-500/20 text-slate-800 dark:text-slate-200 ring-1 ring-slate-500/40",
  },
  {
    key: "ai",
    ...
    pillActiveClass:
      "bg-violet-500/20 text-violet-800 dark:text-violet-200 ring-1 ring-violet-500/40",
  },
  {
    key: "other",
    ...
    pillActiveClass:
      "bg-gray-500/20 text-gray-800 dark:text-gray-200 ring-1 ring-gray-500/40",
  },
];
